...
router.route('/process/doit').post(upload.array('doit', 1), function(req, res) {
    console.log('/process/doit 호출됨');
    ...
    try {
        ...
        if(Array.isArray(files)) {
            ...
            for(var index = 0; index < files.length; index++) {
                ...
                filepath = '/uploads/' + files[index].filename;
        ...
        res.write('<p>작성자 : ' + author + '</p>');
        res.write('<p>날짜 : ' + date + '</p>');
        res.write('<p>내용 : ' + blog + '</p>');
